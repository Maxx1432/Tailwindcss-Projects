    ...
    return (
        <div className='space-y-4 lg:flex'>
            ...
            <div className='lg:flex-1 lg:order-1'>
                ...
                <p className='font-lato text-gray-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti odit commodi maiores harum dolor quae beatae perspiciatis. Sunt, quaerat soluta.</p>
